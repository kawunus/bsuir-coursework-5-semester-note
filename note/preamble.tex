...
\usepackage[left=3cm,top=2cm,right=1.5cm,bottom=2.3cm]{geometry}
...
\DeclareCaptionLabelFormat{stlisting}{Листинг #2}
...
\BeforeBeginEnvironment{lstlisting}{\shorthandoff{"}}
