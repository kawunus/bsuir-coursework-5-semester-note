...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{attachments/worker_start_page.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{attachments/worker_start_page_error.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{attachments/worker_order_statuses.png}
